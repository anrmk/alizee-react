    ...
    <Card variant="outlined" className={classes.itemCard}>
      <CardActionArea onClick={onJoinStream}>
        <CardHeader
          ...
          avatar={
            <Avatar src={item.user.avatarUrl} online={!item.user.offlineDate} />
          }
          title={
          ...
          subheader={
            <Typography noWrap variant="body2" color="textSecondary">
              {item.user.offlineDate
                ? formatDate(item.user.offlineDate)
                : "available now"}
            </Typography>
          }
        ...
        <CardActions disableSpacing className={classes.itemActions}>
          <Box ml={2} display="flex">
            ...
            <Typography
              variant="body2"
              color="textSecondary"
              className={classes.itemCountText}>
          ...
          <Typography
            variant="body1"
            color="primary"
            className={classes.itemJoinTicketPriceText}>
