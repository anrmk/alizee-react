...
export const GET_SETTINGS_RESET_PASSWORD_CONFIRM_REQUEST = "GET_SETTINGS_RESET_PASSWORD_CONFIRM_REQUEST";
export const GET_SETTINGS_RESET_PASSWORD_CONFIRM_SUCCESS = "GET_SETTINGS_RESET_PASSWORD_CONFIRM_SUCCESS";
export const GET_SETTINGS_RESET_PASSWORD_CONFIRM_FAILURE = "GET_SETTINGS_RESET_PASSWORD_CONFIRM_FAILURE";
