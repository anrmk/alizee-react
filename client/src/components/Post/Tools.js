...
function Tools({
  ...
  return (
    <>
      ...
      {amount !== 0 && (
        <Button variant="contained" className="gold" onClick={onBuyClick} startIcon={<MonetizationOnIcon />}>
          {amount} Pay
        </Button>
      )}

      <Button variant="contained" className="primary" onClick={onGoToClick}>
        Watch
      </Button>
    </>
  );
