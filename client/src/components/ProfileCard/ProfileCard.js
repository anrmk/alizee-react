...
function ProfileCard({userName, name, avatarUrl, coverUrl, subtitle, subscriptionPrice, identityVerified}) {
  ...
  return (
    <Card className={classes.root} onClick={() => history.push(PROFILE_USERNAME_ROUTE(userName))}>
      <CardActionArea>
        <CardMedia component="img" image={coverUrl} className={classes.media}></CardMedia>
        ...
        <Avatar borderColor="silver" size="big" src={avatarUrl} className={classes.avatar} />
