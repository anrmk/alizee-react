        ...
        <div className="row align-items-center">
          <div className="col-lg">
                ...
                <div className="form-inline">
                  <button className="btn btn-success mr-2" onClick={() => handleCreate()} >
                    <VideocamOutlinedIcon className="mr-2" /> New meeting
                  </button>
                  <div className="form-group">
                    <input className="form-control" type="link" placeholder="Enter a code or link" />
                  </div>
                  <button className="btn btn-light" onClick={() => handleJoin()} >Join</button>
                </div>
              </div>
          <div className="col-lg">
